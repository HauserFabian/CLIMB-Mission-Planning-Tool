...
Torque_tool_data  = readtable('C:\Users\120960\FHWN\Master Thesis_cloud - Dokumente\10_MOS_Software\CLIMB Operation\Torque_tool_data.xlsx');
...
% 
%         AttitudeSchedule = app.CLIMB.DataProviders.Item('Attitude Segment Schedule').Exec(app.Start_Time,app.End_Time);
...
% 
%         %Command = string(strjoin(['VO  */Satellite/CLIMB SolarPanel Compute ','" ',app.Start_Time,' "',' " ',app.Start_Time,' " 60'],''));
%         % 6 Aug 2023 20:15:04.320,9 Aug 2023 20:15:04.320
%         %Command = 'VO */Satellite/CLIMB SolarPanel Compute "6 Aug 2023 20:15:04.320" "9 Aug 2023 20:15:04.320" 600';
%         stepsize = 600;
%         app.root.UnitPreferences.Item('Power').SetCurrentUnit('W');
%         app.root.ExecuteCommand("VO */Satellite/CLIMB SolarPanel Visualization Radius On 1 AddGroup Solar_Panels");
%         Command = convertCharsToStrings('VO */Satellite/CLIMB SolarPanel Compute "') + app.Start_Time +convertCharsToStrings('" "')+ app.End_Time + convertCharsToStrings('" ') + string(stepsize);
%         app.root.ExecuteCommand(Command);
%         Solar = app.CLIMB.DataProviders.Item('Solar Panel Power').Exec(app.Start_Time,app.End_Time,stepsize);
% 
...
%         writetable(SolarTable,'C:\Users\120960\FHWN\Master Thesis_cloud - Dokumente\10_MOS_Software\CLIMB Operation\CLIMB_Solar_Panel_Power.csv');
% 
% %% Creating Torque Report
%         disp('Creating Torque report')
%         app.ConsoleLog("Creating Torque report");
% 
%         Torque=app.CLIMB.DataProviders.Item('Vectors(Body)').Group.Item('TotalTorque').Exec(app.Start_Time,app.End_Time,5);
...
%         writetable(Torque_table,'C:\Users\120960\FHWN\Master Thesis_cloud - Dokumente\10_MOS_Software\CLIMB Operation\Torque.csv');
% 
% %% Creating Angular Momentum Report
%         disp('Creating Angular Momentum report')
%         app.ConsoleLog("Creating Angular Momentum report");
% 
%         AngMomentum =app.CLIMB.DataProviders.Item('Vectors(Body)').Group.Item('AngMomentum').Exec(app.Start_Time,app.End_Time,5);
...
% 
%         YPR =app.CLIMB.DataProviders.Item('Attitude YPR').Group.Item('Seq RPY').Exec(app.Start_Time,app.End_Time,1);
%         Yaw=YPR.DataSets.GetDataSetByName('Yaw').GetValues;
%         Pitch=YPR.DataSets.GetDataSetByName('Pitch').GetValues;
%         Roll=YPR.DataSets.GetDataSetByName('Roll').GetValues;
%         Yaw_rate=YPR.DataSets.GetDataSetByName('Yaw Rate').GetValues;
%         Pitch_rate=YPR.DataSets.GetDataSetByName('Pitch Rate').GetValues;
%         Roll_rate=YPR.DataSets.GetDataSetByName('Roll Rate').GetValues;
...
% 
% % Fire schedule
%     Fire_data=readtable("C:\Users\120960\FHWN\Master Thesis_cloud - Dokumente\10_MOS_Software\CLIMB Operation\Fire_schedule.csv",'HeaderLines', 1);
