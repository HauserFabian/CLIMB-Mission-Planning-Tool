...
BEGIN Scenario
    ...
    BEGIN Interval
        ...
        Stop		 15 Aug 2023 20:15:04.320000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            StartEvent		
            BEGIN EVENT
            ...
            StopEvent		
            BEGIN EVENT
                Epoch		 15 Aug 2023 20:15:04.320000000
                EpochState		 Explicit
            END EVENT
    ...
    <VAR name = "Model">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                EndTime		 15 Aug 2023 20:15:04.320000000
    ...
    BEGIN References
        ...
        Instance Satellite/CLIMB
            *		
            Satellite/CLIMB		
        END Instance
        Instance Satellite/CLIMB_propagator
            Satellite/CLIMB_propagator		
        END Instance
    END References
